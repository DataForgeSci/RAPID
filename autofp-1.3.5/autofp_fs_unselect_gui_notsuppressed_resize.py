...
from uiset_resize import Ui  # Updated to use uiset_resize
from run import Run
import params
...
def main():
    ...
    # Commented out sections where AutoFP gets automatically closed after detecting the refinement completion flag
    #
