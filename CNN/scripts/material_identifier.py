...
def predict_parameters(material_name, ttheta_values, intensity_values, catalog, output_dir):
    ...
    try:
        ...
        biso_count = param_info['param_counts']['biso'] + param_info['param_counts']['bov']
        ...
        if not scaling_factors:
            ...
            for param_type in param_info['param_types']:
                ...
                elif 'biso' in param_type or 'bov' in param_type:
                    scaling_factors.append(1.0)
        ...
        for param_type in param_info['param_types']:
            ...
            elif 'lattice parameter alpha' in param_type:
                param_names.append('Lattice alpha')
            elif 'lattice parameter beta' in param_type:
                param_names.append('Lattice beta')
            elif 'lattice parameter gamma' in param_type:
                param_names.append('Lattice gamma')
            ...
            elif 'bov' in param_type:
                param_names.append('Bov')
            elif 'scale factor' in param_type:
