...
def main():
    ...
    line13 = lines[12] if len(lines) >= 13 else "n"  # Default to "n" if not present
    print("13> Gave perturbations to Bov instead of Biso?:", line13)
                ...
                try:
                    ...
                    for i, param_type in enumerate(param_types):
                        if param_type == 'zero':
                            ...
                            feature_param_names.append("Bov")
                        elif 'scale factor' in param_type:
